...
Route::group(['prefix' => 'family'], function () {
    ...
    Route::get('/members/{id}', [FamilyMembersController::class, 'memberDetail'])->name('family.members.detail');
    Route::post('/members/update', [FamilyMembersController::class, 'memberUpdate'])->name('family.members.update');
