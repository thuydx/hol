    ...
    <div class="container-fluid border-bottom px-4">
        <button class="header-toggler" type="button" onclick="coreui.Sidebar.getInstance(document.querySelector('#sidebar')).toggle()" style="margin-inline-start: -14px;">
            <svg class="icon icon-lg">
                <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-menu"></use>
            </svg>
        </button>
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="--zgs-dropdown-min-width: 8rem;">
                    <li>
                        <button class="dropdown-item d-flex align-items-center" type="button" data-locale-value="en">
                            <svg class="icon icon-lg me-3">
                                <use xlink:href="{{ Vite::asset('resources/icons/flag.svg') }}#cif-us"></use>
                    ...
                    <li>
                        <button class="dropdown-item d-flex align-items-center" type="button" data-locale-value="vi">
                            <svg class="icon icon-lg me-3">
                                <use xlink:href="{{ Vite::asset('resources/icons/flag.svg') }}#cif-vn"></use>
                    ...
                    <li>
                        <button class="dropdown-item d-flex align-items-center" type="button" data-locale-value="cn">
                            <svg class="icon icon-lg me-3">
                                <use xlink:href="{{ Vite::asset('resources/icons/flag.svg') }}#cif-cn"></use>
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="--zgs-dropdown-min-width: 8rem;">
                    <li>
                        <button class="dropdown-item d-flex align-items-center" type="button" data-theme-value="light">
                            <svg class="icon icon-lg me-3">
                                <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-sun"></use>
                    ...
                    <li>
                        <button class="dropdown-item d-flex align-items-center" type="button" data-theme-value="dark">
                            <svg class="icon icon-lg me-3">
                                <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-moon"></use>
...
{{--                    <svg class="icon me-2">--}}
{{--                        <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-bell"></use>--}}
{{--                    </svg> Updates<span class="badge badge-sm bg-info ms-2">42</span></a>--}}
{{--                    <a class="dropdown-item" href="#">--}}
{{--                        <svg class="icon me-2">--}}
{{--                            <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-envelope-open"></use>--}}
{{--                        </svg> Messages<span class="badge badge-sm bg-success ms-2">42</span></a><a class="dropdown-item" href="#">--}}
{{--                        <svg class="icon me-2">--}}
{{--                            <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-task"></use>--}}
{{--                        </svg> Tasks<span class="badge badge-sm bg-danger ms-2">42</span></a><a class="dropdown-item" href="#">--}}
{{--                        <svg class="icon me-2">--}}
{{--                            <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-comment-square"></use>--}}
...
{{--                    </div>--}}
                    <a class="dropdown-item" href="#">
                    <svg class="icon me-2">
                        <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-user"></use>
                    </svg> Profile</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">
                    <svg class="icon me-2">
                        <use xlink:href="{{ Vite::asset('resources/icons/free.svg') }}#cil-account-logout"></use>
                    </svg> Logout</a>
                </div>
            </li>
        </ul>
