...
export class MenKe_NowRepository extends BaseRepository {
  ...
  async update_COL_9_SUB_2(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_9', 'SUB_2', value)
  }
