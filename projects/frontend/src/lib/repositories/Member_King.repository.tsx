...
export class Member_KingRepository extends BaseRepository {
  ...
  async update_COL_13_SUB_2(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_13', 'SUB_2', value)
  }
  ...
  async update_COL_22_SUB_2(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_22', 'SUB_2', value)
  }

  async update_COL_22_SUB_3(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_22', 'SUB_3', value)
  }

  async update_COL_22_SUB_4(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_22', 'SUB_4', value)
  }

  async update_COL_22_SUB_5(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_22', 'SUB_5', value)
  }

  async update_COL_22_SUB_6(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_22', 'SUB_6', value)
  }
  ...
  async update_COL_25_SUB_2(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_25', 'SUB_2', value)
  }

  async update_COL_25_SUB_3(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_25', 'SUB_3', value)
  }

  async update_COL_25_SUB_4(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_25', 'SUB_4', value)
  }

  async update_COL_25_SUB_5(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_25', 'SUB_5', value)
  }
