...
export class Trade_PlayershopRepository extends BaseRepository {
  ...
  async update_COL_43(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_43', value)
  }

  async update_COL_44(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_44', value)
  }

  async update_COL_45(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_45', value)
  }

  async update_COL_46(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_46', value)
  }

  async update_COL_47(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_47', value)
  }

  async update_COL_48(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_48', value)
  }

  async update_COL_49(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_49', value)
  }

  async update_COL_50(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_50', value)
  }

  async update_COL_51(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_51', value)
  }

  async update_COL_52(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_52', value)
  }

  async update_COL_53(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_53', value)
  }

  async update_COL_54(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_54', value)
  }

  async update_COL_55(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_55', value)
  }

  async update_COL_56(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_56', value)
  }

  async update_COL_57(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_57', value)
  }

  async update_COL_58(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_58', value)
  }

  async update_COL_59(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_59', value)
  }

  async update_COL_60(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_60', value)
  }

  async update_COL_61(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_61', value)
  }

  async update_COL_62(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_62', value)
  }

  async update_COL_63(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_63', value)
  }

  async update_COL_64(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_64', value)
  }

  async update_COL_65(id: string, value: string): Promise<void> {
    await this.updateColumn(id, 'COL_65', value)
  }
}
