...
export class PropPrice_NowRepository extends BaseRepository {
  protected sectionKey = 'PropPrice_Now'
  ...
  async update_COL_6_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_6', 'SUB_0', value)
  }

  async update_COL_6_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_6', 'SUB_1', value)
  }
  ...
  async update_COL_7_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_7', 'SUB_0', value)
  }

  async update_COL_7_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_7', 'SUB_1', value)
  }
  ...
  async update_COL_8_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_8', 'SUB_0', value)
  }

  async update_COL_8_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_8', 'SUB_1', value)
  }
  ...
  async update_COL_9_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_9', 'SUB_0', value)
  }

  async update_COL_9_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_9', 'SUB_1', value)
  }
  ...
  async update_COL_10_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_10', 'SUB_0', value)
  }

  async update_COL_10_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_10', 'SUB_1', value)
  }
  ...
  async update_COL_11_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_11', 'SUB_0', value)
  }

  async update_COL_11_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_11', 'SUB_1', value)
  }
  ...
  async update_COL_13_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_13', 'SUB_0', value)
  }

  async update_COL_13_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_13', 'SUB_1', value)
  }
  ...
  async update_COL_15_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_15', 'SUB_0', value)
  }

  async update_COL_15_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_15', 'SUB_1', value)
  }
  ...
  async update_COL_16_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_16', 'SUB_0', value)
  }

  async update_COL_16_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_16', 'SUB_1', value)
  }
  ...
  async update_COL_17_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_17', 'SUB_0', value)
  }

  async update_COL_17_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_17', 'SUB_1', value)
  }
  ...
  async update_COL_18_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_18', 'SUB_0', value)
  }

  async update_COL_18_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_18', 'SUB_1', value)
  }
  ...
  async update_COL_20_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_20', 'SUB_0', value)
  }

  async update_COL_20_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_20', 'SUB_1', value)
  }
  ...
  async update_COL_21_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_21', 'SUB_0', value)
  }

  async update_COL_21_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_21', 'SUB_1', value)
  }
  ...
  async update_COL_22_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_22', 'SUB_0', value)
  }

  async update_COL_22_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_22', 'SUB_1', value)
  }
  ...
  async update_COL_24_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_24', 'SUB_0', value)
  }

  async update_COL_24_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_24', 'SUB_1', value)
  }
  ...
  async update_COL_25_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_25', 'SUB_0', value)
  }

  async update_COL_25_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_25', 'SUB_1', value)
  }
  ...
  async update_COL_26_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_26', 'SUB_0', value)
  }

  async update_COL_26_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_26', 'SUB_1', value)
  }
  ...
  async update_COL_27_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_27', 'SUB_0', value)
  }

  async update_COL_27_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_27', 'SUB_1', value)
  }
  ...
  async update_COL_28_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_28', 'SUB_0', value)
  }

  async update_COL_28_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_28', 'SUB_1', value)
  }
  ...
  async update_COL_30_SUB_0(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_30', 'SUB_0', value)
  }

  async update_COL_30_SUB_1(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_30', 'SUB_1', value)
  }
