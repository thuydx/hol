...
export class Member_HanmenRepository extends BaseRepository {
  protected sectionKey = 'Member_Hanmen'
  ...
  async update_COL_23_SUB_2(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_23', 'SUB_2', value)
  }

  async update_COL_23_SUB_3(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_23', 'SUB_3', value)
  }

  async update_COL_23_SUB_4(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_23', 'SUB_4', value)
  }

  async update_COL_23_SUB_5(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_23', 'SUB_5', value)
  }

  async update_COL_23_SUB_6(id: string, value: string): Promise<void> {
    await this.updateSubColumn(id, 'COL_23', 'SUB_6', value)
  }
